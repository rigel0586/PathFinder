#ifndef NEWHOUGHMAP3DINTVERTEX_H
#define NewHOUGHMAP3DINTVERTEX_H
...
/**
   Class to calculate the Hough space for circles (center of circle and radius separately) using vertex constaint.
 */
class newHoughMap3DintVertex : public HoughMap
{
    ...
    public:
        ...
        Constructor. Parameters are a vector of basic hits in which circles are to be found and FinderParameters which contain information on Hough space binning etc.
             */
        newHoughMap3DintVertex(std::vector<basicHit>, FinderParameter);

        /**
           Constructor. \todo Is this constructor needed?
         */
        newHoughMap3DintVertex(std::vector<candidateHit>, FinderParameter);

        ///Destructor.
        virtual  ~newHoughMap3DintVertex()
        {
...
#endif //NEWHOUGHMAP3DINTVERTEX_H
